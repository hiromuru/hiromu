...
class ExamsControllerTest < ActionController::TestCase
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post :create, exam: { caption: @exam.caption, discription: @exam.discription, title: @exam.title }
    end
  ...
  test "should update exam" do
    patch :update, id: @exam, exam: { caption: @exam.caption, discription: @exam.discription, title: @exam.title }
    assert_redirected_to exam_path(assigns(:exam))
  end
